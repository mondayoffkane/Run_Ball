 ...
 */
@interface OMIDOdeeoioAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDOdeeoioPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDOdeeoioPartner *)partner
                               ...
                               resources:(NSArray<OMIDOdeeoioVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
