 ...
 */
@interface OMIDOdeeoioAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDOdeeoioAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDOdeeoioVASTProperties *_Nonnull)vastProperties
