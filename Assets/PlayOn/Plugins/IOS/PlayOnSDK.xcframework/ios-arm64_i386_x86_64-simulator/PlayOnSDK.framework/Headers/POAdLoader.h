...
- (void)loadAdWithStringRequest:(NSString*)request completionHandler:(void (^) (POAd *loadedAd, NSError *error))completionHandler;
- (void)loadAdWithBuilder:(POBaseURLGenerator*)builder completionHandler:(void (^) (POAd *loadedAd, NSError *error))completionHandler;
@end
